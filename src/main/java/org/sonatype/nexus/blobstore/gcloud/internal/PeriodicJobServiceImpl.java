 ...
 *
 * TODO: relocate this to nexus-common (copied almost verbatim from nexus-blobstore-file)
 */
@Named
@Singleton
    ...
    implements PeriodicJobService
{
  ...
  protected void doStart() throws Exception {
    // TODO parameterize threadFactoryName
    executor = Executors.newScheduledThreadPool(1,
        new NexusThreadFactory("google-cloud-blobstore-metrics", "blobstore"));
  }
