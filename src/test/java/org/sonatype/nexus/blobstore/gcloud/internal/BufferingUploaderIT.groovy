    ...
    extends Specification
{
  ...
  def "simple multipart"() {
    given:
      ...
      BufferingUploader uploader = new BufferingUploader(1048576)
  ...
  def "confirm parts composed in order"() {
    given:
      ...
      BufferingUploader uploader = new BufferingUploader(5)
  ...
  def "zero byte file"() {
    given:
      long expectedSize = 0
      BufferingUploader uploader = new BufferingUploader(1024)
      byte[] data = new byte[expectedSize]
      new Random().nextBytes(data)
  ...
  def "upload 100 MB"() {
    given:
      ...
      BufferingUploader uploader = new BufferingUploader(1024 * 1024 * 5)
